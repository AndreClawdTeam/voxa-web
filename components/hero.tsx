...
export default function Hero() {
	return (
		<section
			className="relative min-h-screen flex flex-col items-center justify-center hero-grid overflow-hidden lg:pb-24"
		...
		>
			...
			<div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
				...
				>
					A única API de transcrição com preço fixo mensal. Um endpoint, um
					token — em produção em 5 minutos.
				</motion.p>
